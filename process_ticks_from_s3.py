...
def download_from_s3(bucket_name, s3_file_key, local_file_path, region_name='us-east-2'):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--bucket', type=str, required=True, help='The name of the S3 bucket')
    parser.add_argument('--region', type=str, default='us-east-2', help='The AWS region of the S3 bucket')
    ...
    for sym, s3_file_key in s3_file_keys.items():
        ...
        if os.path.exists(local_file_path):
            ...
            print(f"Skipping processing for {local_file_path} as it was not downloaded.")
